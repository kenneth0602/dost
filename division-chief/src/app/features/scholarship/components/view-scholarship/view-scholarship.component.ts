...
@Component({
  ...
  styleUrl: './view-scholarship.component.scss'
})
export class ViewScholarshipComponent {
  ...
  constructor(
    private dialogRef: MatDialogRef<ViewScholarshipComponent>,
  ...
  notifyScholarshipToSupervisor() {
    const token = sessionStorage.getItem('token')
    const employee = this.scholarshipForm.get('employeeName')?.value;
    const id = sessionStorage.getItem('divID')
