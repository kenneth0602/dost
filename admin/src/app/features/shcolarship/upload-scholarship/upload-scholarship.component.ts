...
@Component({
  ...
  templateUrl: './upload-scholarship.component.html',
  styleUrl: './upload-scholarship.component.scss'
})
export class UploadScholarshipComponent {

  selectedFile: File | null = null;
  isDragOver: boolean = false;
  form: FormGroup

  constructor(private dialogRef: MatDialogRef<UploadScholarshipComponent>,
