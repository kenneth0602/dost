...
@Component({
  selector: 'app-view-request-certificate',
  ...
  templateUrl: './view-request-certificate.component.html',
  styleUrl: './view-request-certificate.component.scss'
})
export class ViewRequestCertificateComponent {
  pdfContent: any;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ViewRequestCertificateComponent>,
  ...
  viewCertificate(certId: number) {
    ...
    this.service.viewCertificateByID(certId, token).subscribe(
      (blob: Blob) => {
