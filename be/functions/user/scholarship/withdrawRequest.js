...
const handler = (event,callback) => {
    ...
    const query = `call usr_scholarship_withdrawRequestByID('${sreqID}', '${reqRemarks}');`;
    ...
    pool.getConnection((err,connection) => {
        ...
        connection.query(`SELECT empID FROM users WHERE username ='${username}'`, (err, result) => {
            ...
            connection.query(`INSERT INTO audit_logs(username, target, action) VALUES('${username}', 'Withdraw Scholarship', 'Create');`, (err1, result1) => {
            ...
            connection.query(query, (error,results,fields) => {
                ...
                if(error) {
                    ...
                    callback.status(200).send({message : 'Successfully withdrawn Scholarship.'});
                }
        });
    })
    });
