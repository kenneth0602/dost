...
const handler = (event, callback) => {
    ...
    const query = `call usr_scholarship_getByUser(${empID}, ${pageNo},${pageSize}, '${keyword}');`;
    ...
    pool.getConnection((err, connection) => {
        ...
        connection.query(`select empID from users where username ='${username}'`,(err,result)=>{
            ...
            connection.query(`insert into audit_logs(username, target, action) values('${username}','User competency request','View');`,(err1,result1)=>{
