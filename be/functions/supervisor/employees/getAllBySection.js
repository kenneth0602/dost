...
const handler = (event, callback) => {
    ...
    const query = `call supervisor_employee_getAllEmployeeBySection(${sectionID})`;
    ...
    pool.getConnection((err, connection) => {
        ...
        connection.query(`select empID from users where username ='${username}'`,(err,result)=>{
            ...
            connection.query(`insert into audit_logs(username, target, action) values('${username}','All sections employee.','View');`,(err1,result1)=>{
