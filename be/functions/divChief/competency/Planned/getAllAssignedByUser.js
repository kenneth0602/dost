...
const handler = (event, callback) => {
    ...
    const query = `call all_competency_assigned_getAllCompetencyByUser(${empID})`;
    ...
    pool.getConnection((err, connection) => {
        ...
        connection.query(`select empID from users where username ='${username}'`,(err,result)=>{
            ...
            connection.query(`insert into audit_logs(username, target, action) values('${username}','All Planned Competency','View');`,(err1,result1)=>{
