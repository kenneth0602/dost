...
const handler = (event, callback) => {
    ...
    const formRegID = event.params.formRegID;


    const query = `call admin_forms_getRegistrationByID(${formRegID});`;
    ...
    pool.getConnection((err, connection) => {
        ...
        connection.query(`select empID from admin where username ='${username}'`,(err,result)=>{
            ...
            connection.query(`insert into audit_logs(username, target, action) values('${username}','Registration','View');`,(err1,result1)=>{
