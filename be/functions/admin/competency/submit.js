...
const handler = (event,callback) => {
    ...
    const query = `call admin_aldp_submit(${apID}, ${ID}, ${proposed_year});`;
    ...
    pool.getConnection((err,connection) => {
        ...
        connection.query(query, (error,results,fields) => {
            ...
            if(error) {
                ...
                return callback.status(200).send({message: 'Successfully Submitted to Annual Learning Development Plan', results});
            }
        });
    });
}
