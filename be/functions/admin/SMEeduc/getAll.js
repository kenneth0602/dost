...
const handler = (event,callback) => {
    ...
    const query = `call SMEBE_getAllSMEBE(${pageNo},${pageSize}, '${keyword}');`;
    ...
    pool.getConnection((err,connection) => {
        ...
        connection.query(`select empID from admin where username ='${username}'`,(err,result)=>{
            ...
            connection.query(`insert into audit_logs(username, target, action) values('${username}','SME Educational Background','View');`,(err1,result1)=>{
