...
const handler = (event,callback) => {
    ...
    const query = `call tprov_enableTrainingProviderByID(${provID});`;
    ...
    pool.getConnection((err,connection) => {
        ...
        connection.query(`select empID from admin where username ='${username}'`,(err,result)=>{
            ...
            connection.query(`insert into audit_logs(username, target, action) values('${username}','Training Providers','Reactivate');`,(err1,result1)=>{
