...
const handler = (event,callback) => {
    ...
    const query = `call SMEaffil_createAffiliation('${profileID}', '${orgName}', '${memberSince}', '${role}');`;
    ...
    pool.getConnection((err,connection) => {
        ...
        connection.query(query, (error,results,fields) => {
            ...
            if(error) {
                ...
                return callback.status(200).send({message : 'Successfully created new Affiliation'});
            }
        });
    });
}
