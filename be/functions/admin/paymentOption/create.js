...
const handler = (event,callback) => {
    ...
    const query = `call payment_createPayment('${payee}', '${accountNo}', '${provID}', '${ddPaymentOpt}', '${bankName}', '${TIN}');`;
    ...
    pool.getConnection((err,connection) => {
        ...
        connection.query(query, (error,results,fields) => {
            ...
            if(error) {
                ...
                return callback.status(200).send({message : 'Successfully created new Payment Option'});
            }
        });
    });
}
