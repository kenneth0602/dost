...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 11, 2024 at 04:16 PM
...
LEFT JOIN availability
ON trainingprovider_Program.provID = availability.provID
...
SELECT trainingProvider.provID, providerProgram.pprogID,providerProgram.programName, providerProgram.description, trainingProvider.providerName,  trainingprovider_Program.cost, providerProgram.status
FROM providerProgram
LEFT JOIN trainingprovider_Program
ON providerProgram.pprogID = trainingprovider_Program.pprogID
LEFT JOIN trainingProvider
ON trainingprovider_Program.provID = trainingProvider.provID
WHERE providerProgram.programName 
LIKE (SELECT CONCAT
      ('%', keyword, '%'))
ORDER BY providerProgram.status, providerProgram.programName, trainingProvider.providerName
LIMIT pageSize OFFSET pageNo;
...
(2, NULL, 'undefined', '', 'Internal', 'Technical', NULL, NULL, NULL, NULL, NULL, NULL, '2024-04-11 13:44:28', '0000-00-00 00:00:00', 'For Approval'),
...
(12, NULL, 'test competency', 'test desp', 'External', '', 2, 10, 20, 50000, 'undefined', '2024-03-13', '2024-04-11 13:44:28', '0000-00-00 00:00:00', 'For Approval'),
(13, NULL, 'IT Fundamentals', '', 'Internal', 'Technical', 0, 0, 0, 0, 'undefined', '2024-03-12', '2024-04-11 13:44:28', '0000-00-00 00:00:00', 'For Approval'),
(14, NULL, 'Foreign Language', '', 'Internal', 'Technical', 3, 5, 2, 10000, 'undefined', '2024-03-18', '2024-04-11 13:44:28', '0000-00-00 00:00:00', 'For Approval');
...
--
ALTER TABLE `audit_logs`
  MODIFY `auditID` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6295;

--
-- AUTO_INCREMENT for table `availability`
--
ALTER TABLE `availability`
  MODIFY `availID` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `providerprogram`
  MODIFY `pprogID` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `trainingprovider`
  MODIFY `provID` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT for table `trainingprovider_program`
--
ALTER TABLE `trainingprovider_program`
  MODIFY `tpID` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
