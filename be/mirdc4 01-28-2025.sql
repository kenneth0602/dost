...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 28, 2025 at 09:35 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `admin_form_getUserFeedbackResponse` (IN `formType_val` INT(255), IN `apid_val` INT)   BEGIN
...
INSERT INTO `certificates` (`certID`, `empID`, `programName`, `description`, `trainingprovider`, `type`, `filename`, `startDate`, `endDate`, `pdf_content`, `createdOn`, `cert_status`) VALUES
(11, 1, 'National Certification III', 'NC III Web Development', 'TESDA', 'Self-initiated', NULL, '2018-09-02', '2018-09-03', 0x5b6f626a65637420426c6f625d, '2024-03-11 06:15:54', 'Verified'),
(12, 1, 'National Certification III', 'NC III Web Development', 'TESDA', 'Self-initiated', NULL, '2018-09-02', '2018-09-03', 0x5b6f626a65637420426c6f625d, '2024-03-11 06:18:46', 'Verified'),
(13, 1, 'undefined', 'undefined', 'undefined', '', NULL, '0000-00-00', '0000-00-00', 0x5b6f626a65637420426c6f625d, '2023-09-28 12:51:52', 'For Verification'),
(14, 1, 'National Certification III', 'NC III Web Development', 'TESDA', 'Self-initiated', NULL, '2018-09-02', '2018-09-03', 0x5b6f626a65637420426c6f625d, '2023-09-28 12:54:38', 'For Verification'),
(15, 1, 'undefined', 'undefined', 'undefined', 'Self-initiated', NULL, '0000-00-00', '0000-00-00', 0x5b6f626a65637420426c6f625d, '2023-09-28 12:56:06', 'For Verification'),
(16, 1, 'qwertyu', 'qwertyu', 'qwertyui', 'Self-initiated', NULL, '2023-09-27', '2023-09-29', 0x5b6f626a65637420426c6f625d, '2023-09-28 12:57:57', 'For Verification'),
(17, 1, 'National Certification III', 'NC III Web Development', 'TESDA', 'Self-initiated', NULL, '2018-09-02', '2018-09-03', 0x5b6f626a65637420426c6f625d, '2024-03-11 06:51:03', 'Verified'),
(18, 1, 'sample data', 'sample description', 'training prvoder', 'Self-initiated', NULL, '2023-10-07', '2023-10-13', 0x5b6f626a65637420426c6f625d, '2024-03-11 06:24:07', 'Verified'),
(19, 5, 'Test ProgName', 'Test Desc', 'Test Provider', 'Self-initiated', NULL, '2023-11-04', '2023-11-06', '', '2024-03-11 06:23:29', 'Verified'),
(20, 1, 'ISO Lead Risk Manager', 'ISO Lead Risk Manager Certificate', 'PECB', 'Self-initiated', NULL, '2024-03-10', '2024-03-10', 0x5b6f626a65637420426c6f625d, '2024-03-11 06:29:43', 'Verified'),
(21, 1, 'jhkjasgbgddsgjh', 'dsgjrngrio', 'dsnkgeorrno reg', 'Self-initiated', NULL, '2024-03-10', '2024-03-27', 0x5b6f626a65637420426c6f625d, '2024-07-01 08:08:21', 'Verified'),
(22, 1, 'test', 'teststs', 'test', 'Self-initiated', NULL, '2024-03-19', '2024-03-27', 0x756e646566696e6564, '2024-04-26 06:36:13', 'Verified'),
(23, 2, 'Presentation', 'SSDLC', 'SP', 'Self-initiated', NULL, '2025-01-21', '2025-01-22', 0x756e646566696e6564, '2025-01-22 02:18:53', 'Verified'),
(30, 2, 'National Certification III', 'NC III Web Development', 'TESDA', 'Self-initiated', NULL, '2018-09-02', '2018-09-03', 0x5b6f626a656374204f626a6563745d, '2025-01-22 05:51:59', 'For Verification'),
(31, 2, 'National Certification III', 'NC III Web Development', 'TESDA', 'Self-initiated', NULL, '2018-09-02', '2018-09-03', 0x5b6f626a656374204f626a6563745d, '2025-01-22 06:02:12', 'For Verification'),
(32, 2, 'National Certification III', 'NC III Web Development', 'TESDA', 'Self-initiated', 'Darlene Fe C. Cabarillas.pdf', '2018-09-02', '2018-09-03', 0x5b6f626a656374204f626a6563745d, '2025-01-28 07:36:07', 'Rejected'),
(33, 2, 'Sample', 'Sample Descriptiondsasfa', 'SP', 'Self-initiated', 'Sitemap.pdf', '0000-00-00', '0000-00-00', 0x5b6f626a656374204f626a6563745d, '2025-01-23 03:54:33', 'Rejected'),
(34, 2, 'gsgds', 'gdsgsd', 'gsdgdsgds', 'Self-initiated', 'Sitemap.pdf', '0000-00-00', '0000-00-00', 0x5b6f626a656374204f626a6563745d, '2025-01-23 03:50:04', 'Verified'),
(35, 2, 'Wordpress', 'Wordpress and cms', 'Sitesphil', 'Self-initiated', 'Filtered_Markers_All_Categories (1).pdf', '0000-00-00', '0000-00-00', 0x5b6f626a656374204f626a6563745d, '2025-01-28 08:01:26', 'Verified');
...
(32, 37, 2, 1, 'Confirm', '2025-01-22', 'Approved', NULL, NULL, '2024-12-05'),
...
--
ALTER TABLE `audit_logs`
  MODIFY `auditID` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12840;
...
--
ALTER TABLE `certificates`
  MODIFY `certID` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `forms`
  MODIFY `formID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `forms_options`
  MODIFY `optionsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=607;
...
--
ALTER TABLE `user_answer`
  MODIFY `userAnswerId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=182;
