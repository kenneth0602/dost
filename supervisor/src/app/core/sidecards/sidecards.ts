...
@Component({
  ...
  templateUrl: './sidecards.html',
  styleUrl: './sidecards.scss'
})
export class Sidecards {
  ...
  constructor(private router: Router, private service: CoreService, private dialogRef: MatDialogRef<Sidecards>) {
